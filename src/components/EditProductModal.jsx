...
function EditProductModal({ isOpen, onClose, onSave, onDelete, product, categories }) {
          ...
          <div className="space-y-3 pt-2">
            ...
            {onDelete && (
              <button
                ...
                className="w-full px-6 py-3.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl font-bold hover:from-red-600 hover:to-red-700 transition-all shadow-lg hover:shadow-xl active:scale-95 flex items-center justify-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
