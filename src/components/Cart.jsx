function Cart({ cart, onRemoveItem, onUpdateQuantity, isOpen, onToggle }) {
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="fixed bottom-6 right-6 bg-emerald-500 text-white p-5 rounded-full shadow-xl z-50 hover:bg-emerald-600 transition-all duration-200 hover:scale-110 active:scale-95 md:hidden"
      >
